...
class Processor:
    ...
    def __init__(self, http_request_queue: Queue, CFG):
        self._endpoints = {}
        self._cfg = CFG
    ...
    def process_http_req(self, req: HTTPGetRequest):
        ...
        if req.name == self.SET_REG_HTTP_COMMAND:
            ...
            if len(req.params) == 0 or req.params.get('r') is None or req.params.get(
                'v') is None or req.params.get('n') is None:
            ...
            if len(req.params) == 0 or req.params.get('n') is None:
    ...
    def set_reg(self, req: HTTPGetRequest):
        ...
        try:
            ...
            self._logger.warning('Incorrect device id %s' % req.params['n'])
            return
